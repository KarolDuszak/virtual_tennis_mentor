...
import 'package:virtual_tennis_mentor/features/mentor_center/domain/usecases/update_match_dynamic_information_by_id.dart';
...
void main(){
  ...
  test(
    ...
    () async {
      ...
      when(() => mockMatchDynamicRepository.updateMatchDynamicInformationById(tId))
      ...
      verify(() => mockMatchDynamicRepository.updateMatchDynamicInformationById(tId));
